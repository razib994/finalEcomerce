...
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('/')}}dash/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- DataTables -->
<script src="{{asset('/')}}dash/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="{{asset('/')}}dash/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- Morris.js charts -->
<script src="{{asset('/')}}dash/bower_components/raphael/raphael.min.js"></script>
<script src="{{asset('/')}}dash/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="{{asset('/')}}dash/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="{{asset('/')}}dash/bower_components/moment/min/moment.min.js"></script>
<script src="{{asset('/')}}dash/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="{{asset('/')}}dash/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
