...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{asset('/')}}dash/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{asset('/')}}dash/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{asset('/')}}dash/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="{{asset('/')}}dash/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{asset('/')}}dash/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Laravel</b> E-Comerce</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('/')}}dash/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('/')}}dash/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('/')}}dash/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('/')}}dash/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('brand/manage')}}"><i class="fa fa-circle-o"></i> Manage Brand</a></li>
